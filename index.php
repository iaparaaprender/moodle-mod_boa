...
\mod_boa\event\course_module_instance_list_viewed::create_from_course($course)->trigger();

$PAGE->set_url('/mod/boa/index.php', ['id' => $id]);
$PAGE->set_title(format_string($course->fullname));
$PAGE->set_heading(format_string($course->fullname));

echo $OUTPUT->header();

$modulenameplural = get_string('modulenameplural', 'mod_boa');
echo $OUTPUT->heading($modulenameplural);

$instances = get_all_instances_in_course('boa', $course);
...
foreach ($instances as $instance) {
    ...
    $link = html_writer::link(
        new moodle_url('/mod/boa/view.php', ['id' => $instance->coursemodule]),
